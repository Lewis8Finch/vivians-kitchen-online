    ...
    <main className="mx-auto max-w-6xl px-5 pb-24 pt-8 md:pb-10 md:pt-12">
      <div className="mb-6 flex items-end justify-between">
        <div>
          ...
          <h1 className="font-anton mt-1 text-5xl uppercase tracking-tight text-ink md:text-6xl">Visit Vivian's</h1>
        </div>
      ...
      <div className="rounded-2xl bg-ink p-6 text-cream md:p-10">
        <div className="grid gap-8 md:grid-cols-2">
          <div>
            <h2 className="font-anton text-3xl uppercase tracking-tight">Gacharage Junction, Ruaka</h2>
          ...
          <div className="space-y-4 rounded-xl border border-cream/15 bg-cream/5 p-5">
            <h3 className="font-anton text-xl uppercase tracking-tight text-butter">Order by phone</h3>
